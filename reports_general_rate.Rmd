...
6. Write [`sp_rate_referral_ts`]() on the web production database. The following code calls this procedure from `R`, and displays the first five rows of a result set. 
